...
namespace Entity
{
    ...
    /// 工厂间采购收货 任务表
    /// </summary>
    public class MES_ReceiveRecordTask
    {
        private int _index;
        private string _taskId;
        private Dictionary<int, MES_ReceiveRecord> _items = new Dictionary<int, MES_ReceiveRecord>();

        public virtual void AddItem(MES_ReceiveRecord item)
        {
            this._index++;
        ...
        public Dictionary<int, MES_ReceiveRecord> Items
        {
            get
            {
                return this._items;
    ...
    /// 工厂间采购收货业务记录表
    /// </summary>
    public class MES_ReceiveRecord
    {
        /// <summary>
        /// 收货ID，GUID
        /// 一组有多个行项目，组ID相同。
